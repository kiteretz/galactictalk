...
<?php
	cx(
		is_front_page() ? 'js-header' : '',
		'sticky top-0 z-50 w-full max-w-1600 lg:mx-auto lg:px-40'
	)
	?>
">
	<div class="rounded-b-12 bg-black/50 backdrop-blur-[1.25rem] py-8 px-16 lg:flex lg:items-center lg:justify-between lg:rounded-b-16 lg:p-16 lg:shadow-md">
		<div class="flex items-center justify-between">
			<a class="flex justify-center p-8" href="<?php echo esc_url( home_url( '/' ) ); ?>">
				<img class="h-24 w-auto lg:h-32" src="<?php echo esc_url( get_theme_file_uri( '/assets/images/logo.svg' ) ); ?>" alt="<?php bloginfo( 'name' ); ?>" width="178" height="32">
			</a>
