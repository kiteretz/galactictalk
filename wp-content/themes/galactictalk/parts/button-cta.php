...
<a class="<?php cx( 'mx-auto grid h-80 !max-w-640 grid-cols-[auto,1fr] grid-rows-[5rem] items-center rounded-full bg-[theme(colors.pink.DEFAULT)] pl-0 pr-28 tracking-[-0.02em] lg:h-120 lg:!max-w-col-10 lg:grid-cols-[repeat(3,auto)] lg:grid-rows-[7.5rem] lg:pl-48 lg:pr-0', $args['class'] ); ?>" href="#">
	...
	<div class="relative col-[1/2] row-[1/2] grid w-130 place-items-center *:col-span-full *:row-span-full lg:col-auto lg:row-auto lg:w-248">
		<img class="hidden lg:block w-42 translate-x-[2rem] translate-y-[-0.5rem] rotate-[24deg] scale-x-[-1] lg:w-108 lg:translate-x-[-2rem] lg:translate-y-[-1.5rem]" src="<?php echo esc_url( get_theme_file_uri( '/assets/images/headphone.webp' ) ); ?>" alt="" width="108" height="136">
		<img class="hidden lg:block w-18 translate-y-[1.25rem] rotate-[-19deg] lg:w-50 lg:translate-x-[3rem] lg:translate-y-[0.5rem]" src="<?php echo esc_url( get_theme_file_uri( '/assets/images/crystal-yellow.webp' ) ); ?>" alt="" width="50" height="78">
	</div>
</a>
