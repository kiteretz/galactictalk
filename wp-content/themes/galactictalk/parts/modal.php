...
?>
<!-- <button class="js-modal-trigger" data-target-menu="info">
	お知らせモーダルを開く（ボタン）
</button>
<a href="#modal-info" class="js-modal-trigger" data-target-menu="info">
	お知らせモーダルを開く（リンク）
</a>
...
<?php
	cx(
		...
		'aria-[hidden=false]:opacity-100 aria-[hidden=false]:pointer-events-auto aria-[hidden=false]:-translate-y-1/2',
	)
	?>
" aria-hidden="true" role="dialog" aria-labelledby="modal-info-title">
	<h2 id="modal-info-title" class="text-[#07030E] font-barlow font-bold uppercase text-center text-64 leading-none tracking-[-0.02em]">
	Thank you<br />
	for Visiting
	</h2>
